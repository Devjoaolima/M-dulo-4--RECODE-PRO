    ...
    <nav class="navbar bg-body-tertiary" >
        ...
        <div class="wrapper">
          <div class="card">
            ...
            <div class="details">
              <h1>Roma -  Italia</h1>
              <h7>Valor: R$:500.08</h7>
              <h7>Taxa: R$:270</h7>
              <div class="rating">
              </div></div>
          </div>
          <div class="card">
            <div class="poster"><img src="https://www.visitbrasil.com/wp-content/uploads/2021/08/Sao-Paulo-SP-Visit-Brasil-8-1-1024x683.jpg" alt="Location Unknown"></div>
            <div class="details">
              <h1>São Paulo - Brasil</h1>
              <h7>Valor: R$:658.00</h7>
              <h7>Taxa: R$:100</h7>
              <div class="rating">
                <ul></ul>
              </div></div>
          ...
          <div class="card">
            ...
            <div class="details">
              <h1>Berlin - Alemanha</h1>
              <h7>Valor: R$:700.10</h7>
              <h7>Taxa: R$:325</h7>
            </div></div>
        </div>
      </div>
      ...
      <div class="wrapper">
        <div class="card">
          <div class="poster"><img src="https://destinosnotaveis.com.br/wp-content/uploads/2021/06/madri-espanha-1024x612.jpg" alt="Location Unknown"></div>
          <div class="details">
            <h1>Madrid - Espanha </h1>
            <h7>Valor: R$:889.09</h7>
              <h7>Taxa: R$:158</h7>
            <div class="rating">
            </div></div>
        </div>
        ...
        <div class="card">
          <div class="poster"><img src="https://www.worldatlas.com/upload/a5/62/5d/shutterstock-1135796237.jpg" alt="Location Unknown"></div>
          <div class="details">
            <h1>Texas - Estados Unidos</h1>
            <h7>Valor: R$:729.00</h7>
              <h7>Taxa: R$:169</h7>
            <div class="rating">
              <ul></ul>
            </div></div>
        ...
        <div class="card">
          <div class="poster"><img src="https://positivoturismo.com.br/wp-content/uploads/2019/07/argentina-buenos-aires-dawn-at-center-with-rush-hour-667138246-5b5f85ac46e0fb00258228a8.jpg" alt="Location Unknown"></div>
          <div class="details">
            <h1>Buenos Aires - Argentina</h1>
            <h7>Valor: R$:1050.00</h7>
              <h7>Taxa: R$:56</h7>
          </div></div>
      </div>
